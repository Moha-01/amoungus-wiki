 ...
 <html lang="de">
     ...
     <body id="body">
       ...
       <section class="content_section">
           ...
           <img class="welcome_img" src="../assets/news_letter.jpeg" alt="Success Banner">
           <br>

           <?php
             echo "<p class=\"aside_p\"> Thank you for login into our News-Letter. You will recive News and Updates on your E-Mail: <strong> ($email) </strong>.<p>";
